          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className={`text-lg ${resolvedTheme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                Increase sales efficiency with professional AI support
              </p>
            </div>
          </div>
          <p className={`${resolvedTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'} max-w-4xl`}>
            Boost your sales performance with AI-powered lead generation, pitch optimization, and customer engagement tools.
          </p>
        </div>
      </div>

      <div className={`${resolvedTheme === 'dark' ? 'bg-[#1E293B]' : 'bg-white'} border-b ${resolvedTheme === 'dark' ? 'border-gray-700' : 'border-gray-200'} sticky top-0 z-40 hidden`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-4">
              <button
